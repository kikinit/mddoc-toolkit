...
export class MarkdownParser {
  ...
  // Get an array of the section(s) for the provided heading.
  getSectionsWithHeading (keyword) {
    // TODO: Validate input

    const keywordLower = keyword.toLowerCase()
    const matchingSections = this.sections.filter(section => section.heading.toLowerCase().includes(keywordLower))
