...
export class CodeRepoReadmeParser extends MarkdownParser {
  ...
  getTitleAndDescription() {
    ...
    return titleSection ? { title: titleSection.heading, description: titleSection.body } : null
  }
  ...
  getInstallationInstructions() {
    ...
    return installSection ? installSection.body : null
  }
  ...
  getUsageExamples() {
    ...
    return usageSection ? usageSection.body : null
  }
  ...
  getContributionGuidelines() {
    ...
    return contributionSection ? contributionSection.body : null
  }
  ...
  getLicenseInfo() {
    ...
    return licenseSection ? licenseSection.body : null
  }
}
